...
if cfgStruct.physical.singleTransmitterFlag
    ...
    arrayOutput = zeros(simDuration_Samples,cfgStruct.physical.nSensors);
end

objectsInput            = cell(1,cfgStruct.physical.nSensors);
objectsInput(:)         = {zeros(simDuration_Samples,1)};
...
for segmentId=1:simNSegments
    ...
    objectsNominalInput_CELL = ...
        ...
        cellfun( ...
        @(objDelayedTime) ... each object contributes differently to each sensor
